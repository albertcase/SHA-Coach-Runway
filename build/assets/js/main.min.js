...
var shareArr = {
    "_title": '亲临Coach大秀现场，抢先入手2017秋冬系列', //分享标题
    "_desc": "亲临Coach大秀现场，抢先入手2017秋冬系列",    // 分享朋友圈的描述
    "_desc_friend": "点击入场Coach2017秋冬大秀，一键购买当季火爆新款 ",    // 分享好友的描述
...
function vFun(){
    ...
    // 弹层
    self.prompt = function(node, status){
        if(status){
